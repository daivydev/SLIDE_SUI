...
export const MintSlideModal = ({ isOpen, onClose, slideData, onMintSuccess }) => {
                ...
                return (
                    <div className="text-center py-8">
                        <div className="w-16 h-16 bg-cyan-500/20 rounded-full flex items-center justify-center mx-auto mb-4">
                            <svg className="w-8 h-8 text-cyan-400 animate-pulse" viewBox="0 0 24 24" fill="currentColor">
                ...
                return (
                    <>
                        ...
                        <div className="bg-white/5 rounded-xl p-4 mb-6">
                            ...
                            <p className="text-lg font-semibold text-white truncate">{slideData?.title || 'Untitled Slide'}</p>
                        </div>
                                ...
                                <div className="flex gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-cyan-400/70 mt-1">
                                            Your slide will be uploaded to IPFS and minted as a SUI Object. You'll own it and can sell licenses or transfer ownership.
                                        </p>
                                    </div>
                                </div>
                            </div>
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
            <div className="absolute inset-0 bg-black/70 backdrop-blur-sm" onClick={step === 'input' ? onClose : undefined} />
