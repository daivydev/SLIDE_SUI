  ...
  return (
    <div className="py-10">
      ...
      <div className="flex items-center justify-between mb-10">
        <div>
          <h1 className="text-4xl font-bold">My Slides</h1>
        ...
        <button
          ...
          className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-500 hover:to-cyan-500 rounded-xl font-semibold transition-all shadow-lg shadow-blue-500/25"
        >
      ...
      {!isLoading && slides.length === 0 && (
        <div className="flex flex-col items-center justify-center py-20 text-center">
          ...
          <p className="text-gray-500 mb-6">Create your first slide presentation to get started</p>
          <button
            onClick={() => navigate('/editor')}
              ...
              <div className="aspect-video bg-gray-800 relative overflow-hidden">
                ...
                <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-3">
                  ...
                  <button
                    ...
                    className="p-3 bg-cyan-600 hover:bg-cyan-500 rounded-xl transition-colors"
                    title="Present"
                  >
                    <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
